    ...
    <div className="flex min-h-[calc(100vh-4rem)] items-center justify-center px-6">
      ...
      >
        <div className="border-border bg-surface rounded-2xl border p-8 text-center shadow-xl">
          ...
          <h1 className="text-text-primary mb-2 text-2xl font-semibold">{t("common.appName")}</h1>
          <p className="text-text-secondary mb-8 text-sm">{t("login.subtitle")}</p>
          ...
          <p className="text-text-secondary mt-6 text-xs">{t("login.termsNotice")}</p>
        </div>
      </motion.div>
    </div>
  );
