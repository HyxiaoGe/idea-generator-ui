    ...
    <div className="flex min-h-[calc(100vh-4rem)] items-center justify-center px-6">
      ...
      >
        <div className="border-border bg-surface rounded-2xl border p-8 text-center shadow-xl">
          {/* Logo */}
          <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-[#7C3AED] to-[#2563EB] shadow-lg shadow-[#7C3AED]/30">
          ...
          <Button
            onClick={login}
            className="w-full rounded-xl bg-gradient-to-r from-[#7C3AED] to-[#2563EB] py-6 text-base hover:from-[#7C3AED]/90 hover:to-[#2563EB]/90"
          >
